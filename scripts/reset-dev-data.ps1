...
docker compose exec -T postgres psql `
  ...
  -c "TRUNCATE TABLE chat_messages, chat_sessions, processing_jobs, quiz_responses, quiz_attempts, quiz_questions, document_mind_maps, document_summaries, flashcards, document_chunks, documents RESTART IDENTITY;"
Pop-Location
